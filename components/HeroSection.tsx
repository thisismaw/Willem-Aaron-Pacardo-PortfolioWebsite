      ...
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-center md:justify-between gap-8 md:gap-12 lg:gap-16">
          <div className="md:w-1/2 lg:w-3/5 text-center md:text-left order-2 md:order-1">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold mb-4 sm:mb-6 leading-tight tracking-tight text-slate-800"> Streamline Your Business, <span className="block sm:inline text-cyan-700">Amplify Your Impact.</span> </h1>
            <p className="text-lg sm:text-xl lg:text-2xl mb-6 sm:mb-8 font-normal text-slate-600 max-w-xl mx-auto md:mx-0"> I&apos;m Aaron, your expert Virtual Assistant. I transform your daily operations—managing digital content, customer communications, and essential tasks with tools like WordPress, Notion, and Google Workspace. Partner with me for improved efficiency, reliable support, and a clear path to greater productivity and business growth. </p>
