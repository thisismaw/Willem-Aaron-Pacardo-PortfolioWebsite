        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-lg sm:text-xl text-slate-600 max-w-2xl mx-auto">
              A curated collection of projects showcasing my expertise in WordPress, video editing, social media, and operational support using tools like Notion and Google Workspace. Click on a project to see more details.
            </p>
          </div>
